...
<section class="content-header">
    <h1>
    Sửa thông tin Mã giảm giá <a href="{{route('coupon.index')}}" class="btn bg-aqua"><i class="fa fa-list"></i> Danh sách </a>
    </h1>
</section>
                ...
                <form role="form" action="{{ route('coupon.update', ['id' => $coupon->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="checkbox">
                                <label>
                                    <input {{ ($coupon->status == 1) ? 'checked':'' }} type="checkbox" value="1" name="status">
                                    Trạng thái hiển thị
                                </label>
                            </div>
                        </div>
