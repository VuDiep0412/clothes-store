...
<section class="content-header">
    <h1>
        Danh Sách <a href="{{route('admin.productColor.create')}}" class="btn bg-aqua"><i class="fa fa-plus"></i> Thêm mới</a>
    </h1>
</section>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr class="item-{{ $productSize->id }}">
                                ...
                                <td class="text-center">{{ $productSize->color->name }}</td>
                                <!-- <td class="text-center">{{ $productSize->number }}</td> -->
                                <td class="text-center">

                                    <button onclick="deleteItem('product_color', {{$productSize->id}})" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                </td>
